...
`${DOTD}`: The layer's companion directory, ie `${DIRECTORY}/${STEM}.d`, where it ships its hooks and overlays - `${DOTD}/hooks`. Written this way the path survives a rename of the layer file. Expands whether or not the directory exists.
